...
* **Localization:** Fully supports **Multi-language (English/Hebrew)** with RTL (Right-to-Left) support.
...
The entire ecosystem (Database, API, and Client) can be launched with a single command using Docker Compose.

### Prerequisites:
* [Docker Desktop](https://www.docker.com/products/docker-desktop/) installed and running.

### How to Run:
1.  Open your terminal in the root directory (`TransactionSimulator`).
